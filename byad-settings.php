...
if(!class_exists('Byad_Countdown_Settings')) {
    ...
    public function admin_init() {
    	...
    	register_setting('byad-countdown-group', 'byad_countdown_date_picker');
    	register_setting('byad-countdown-group', 'byad_countdown_dateformat');
    	register_setting('byad-countdown-group', 'byad_countdown_time');
    	register_setting('byad-countdown-group', 'byad_countdown_deadend');
    	register_setting('byad-countdown-group', 'byad_countdown_years');

    	// add your settings section
    	add_settings_section(
    	    'byad-countdown-section', 
    	    __('BYAD Countdown Settings', 'byad-countdown'), 
      ...
      add_settings_field( 
        ...
        __('Final Date', 'byad-countdown'),
        array(&$this, 'byad_countdown_display_date_picker'),
        'byad-countdown', 
        'byad-countdown-section',
        array(
          'field' => 'byad_countdown_date_picker',
          'description' => __('Click and select the countdown end date. If empty, you are dead tomorrow after midnight.', 'byad-countdown'),
        )
      );
      ...
      add_settings_field(
        ...
        array(
          ...
          'description' => __("Please choose a date format. It must match the format of Final date field!", 'byad-countdown'),
          'options' => array( 
      ...
      add_settings_field(
        'byad-countdown-setting_time', 
        __('Time', 'byad-countdown'), 
        array(&$this, 'settings_field_input_text'), 
        'byad-countdown', 
        'byad-countdown-section',
        array(
          'field' => 'byad_countdown_time',
          'description' => __("Optionnaly you can specify at what time (HH:MM) you'll die on your Final date (leave empty to die at midnight at the end of the day)", 'byad-countdown'),
          'value' => get_option('byad_countdown_time', ''),
        )
      );
